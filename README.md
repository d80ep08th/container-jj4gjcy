...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jj4gjcy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jj4gjcy.containers.anotherwebservice.com/
...
```
git clone git@github.com:d80ep08th/container-jj4gjcy.git
cd container-jj4gjcy
```
...
```
docker attach container-jj4gjcy
```
